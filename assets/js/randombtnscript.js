    ...
    fetch("https://api.spoonacular.com/recipes/random?apiKey=" + spoonApiKey)
        ...
        .then(function (data) {
            ...
            for (var q = 0; q <= data.recipes[0].analyzedInstructions[0].steps.length; q++) {
                let instructions = data.recipes[0].analyzedInstructions[0].steps[q].step
                $("#randomInstructions").append("<li>" + instructions + "</li>")

            };
            console.log(data.recipes[0].analyzedInstructions)
...
//instructions
                for (var a = 0; a <= userResults.analyzedInstructions[0].steps.length; a++) {
                    let instructions = userResults.analyzedInstructions[0].steps[a].step;                    $("#instructions").append
                        ("<li>" + instructions + "</li>")
                };
